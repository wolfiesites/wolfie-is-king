...
$display_content = $atts['choosen_content'];
	...
	while ( $the_query->have_posts() ) {
		...
		<div class="item list-item post-<?php echo esc_attr( $post->ID ); ?>">
			...
			<div class="post-content">
				...
				<?php
				if ($display_content == 'wolfie-excerpt' ) {
					$post_content = apply_filters('sk_the_excerpt', get_the_excerpt() );
				} else {
				...
				<div class="in-post-content"><?php echo wp_trim_words( $post_content, 60, ' ...' ); ?></div>
