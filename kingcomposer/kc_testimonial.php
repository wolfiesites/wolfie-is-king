<?php
$title = $desc = $image = $img_size = $position = $custom_class = $data_img = $data_title = $data_desc = $data_rating = $data_position = '';
$layout = 1;
...
if ( !empty( $rating ) && $show_rating == 'yes' ) {
	$percent = $rating/50*100;
	ob_start();
	?>
	<div class="content-rating">
		<div class="star-ratings">
			<div class="fill-ratings" style="width: <?php echo $percent ?>%;">
				<span>★★★★★</span>
			</div>
...
<?php
wp_enqueue_script('kc-testimonial');